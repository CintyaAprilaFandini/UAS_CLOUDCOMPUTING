...
@section('container')
    ...
    <div class="row my-5 bg-white">
        <div class="col-md-5 mx-5">
            <h1>Sistem Informasi Pengelolaan Us-Kost</h1>
            <p>Website Sistem Informasi Pengelolaan Us-Kost yang mempunyai fungsi pelaporan, pembayaran, pengajuan, dan
                penyewaan.</p>
    ...
    <div class="row my-5" style="background-color: #EEE">
        <h2 class="m-5">Keunggulan Us-Kost</h2>
