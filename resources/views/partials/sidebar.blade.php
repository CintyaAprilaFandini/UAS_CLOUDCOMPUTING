<div class="app-brand demo">
    <a href="/" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">Us-Kost</span>
    </a>
...
<ul class="menu-inner py-1">
    ...
    <!-- Layouts -->
    <li class="menu-item {{ Request::is('dashboard/profil*') ? 'active ' : '' }}">
    ...
    @if (auth()->user()->status != 'penyewa')
        ...
        @if (auth()->user()->status == 'admin')
            <li class="menu-item {{ Request::is('dashboard/kost*', 'dashboard/kamar*') ? 'active ' : '' }}">
                <a href="/dashboard/kost" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-building-house"></i>
                    <div data-i18n="Kost-kostabn">Kost-kostan</div>
                </a>
            </li>
    ...
    <!-- Cards -->
    <li class="menu-item {{ Request::is('dashboard/penyewaan*') ? 'active ' : '' }}">
        <a href="/dashboard/penyewaan" class="menu-link">
            <i class="menu-icon tf-icons bx bx-book-bookmark"></i>
            <div data-i18n="Penyewaan">Penyewaan</div>
        </a>
    </li>
    <!-- User interface -->
    <li class="menu-item {{ Request::is('dashboard/pembayaran*') ? 'active ' : '' }}">
